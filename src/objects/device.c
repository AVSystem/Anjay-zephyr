...
static int resource_read(anjay_t *anjay,
    ...
    case RID_MANUFACTURER:
        ...
        return anjay_ret_string(ctx, CONFIG_ANJAY_ZEPHYR_DEVICE_MANUFACTURER);

    case RID_MODEL_NUMBER:
        assert(riid == ANJAY_ID_INVALID);
        return anjay_ret_string(ctx, CONFIG_ANJAY_ZEPHYR_MODEL_NUMBER);
...
const anjay_dm_object_def_t **_anjay_zephyr_device_object_create(void) {
    ...
    if (_anjay_zephyr_get_device_id(&obj->serial_number)) {
